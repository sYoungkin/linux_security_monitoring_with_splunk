# See the wiki for a walkthrough of the use case demonstration and for useful links to the Splunk apps
...
and just "ip a" to get the address. It will have this address until you destroy the vm.
